...
const WhatsAppIcon = () => <svg className="w-6 h-6 pointer-events-none" viewBox="0 0 24 24" fill="currentColor">
    ...
    <div className="container mx-auto max-w-5xl text-center relative z-10">
      ...
      <motion.div initial={{
        ...
        <button onClick={handleWhatsAppClick} className="btn-whatsapp text-sm">
          <WhatsAppIcon />
          <span className="pointer-events-none">Let's talk about your demo</span>
        </button>
      </motion.div>
    </div>
